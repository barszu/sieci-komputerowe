...
VLANy pozwalają na stworzenie logicznej topologi sieci na podstawie fizycznej więc na zadaniach warto `rozrysować logiczną strukturę sieci`

`Granicą VLANu jest router`, który pozwala na komunikację między VLANami poprzez użycie routingu

Każdy VLAN powinien otrzymać `rózne adresy sieci IP`, (można a nawet wskazane jest użycie VLSM)
