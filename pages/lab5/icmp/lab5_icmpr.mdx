...
Router wysyła do hosta wiadomość "słabo kierujesz ruchem, lepiej będzie jeśli dla **kolejnych** pakietów do sieci X
użyjesz routera Y", host powinien zapisać tą informację w swojej tablicy routingu i skorzystać z niej w przyszłości
