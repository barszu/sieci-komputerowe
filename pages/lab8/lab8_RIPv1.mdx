...
- `metryka - liczba hopów` (routerów po drodze do sieci) - `maksymalnie 15`
...
- `zliczanie do nieskończoności` - jeśli router nie zna drogi do jakiejś sieci, to ustawia metrykę na `16` (maksymalna wartość | infinity) i przesyła ją dalej
- protokół klasowy, `nie obsługuje VLSM`
- **generuje dużo ruchu**
...
- broadcast nie jest dobry np. dla dużych sieci
...
Przykład: router Z wysyła pakiety do X przez router Y, dystanse na rysunku
