...
- **`Tablica forwardingu` (FDB)**: `SWITCH_PORT : MAC` (sprzętowo realizowany hash table -> pamięć CAM)
...
- bridge to nie musi być switch z 2 portami !!!
...
- switch często potrafi wiele ramek naraz przesyłać, interpretować
